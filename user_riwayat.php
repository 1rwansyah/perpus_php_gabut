...
<div class="container py-4">
    <div class="d-flex align-items-start align-items-md-center justify-content-between mb-3 flex-column flex-md-row">
        <div class="mb-2 mb-md-0">
            <h1 class="h4 mb-0 text-gray-800">Riwayat</h1>
    ...
    <div class="card shadow-sm mb-4 topbar-card">
        <div class="card-body">
            ...
            <div class="small text-muted mt-2">Menampilkan <strong><?= count($history) ?></strong> dari <strong><?= $totalRows ?></strong></div>
        </div>
    </div>
                        ...
                        <div class="history-card">
                            ...
                            <div class="history-overlay">
                                ...
                                <div class="meta-row">
                                    ...
                                    <span class="author-mini"><?= htmlspecialchars((string)($h['author_buku'] ?? '')) ?></span>
                                </div>
                            </div>
                        </div>
                    </a>
        ...
        <?php if ($totalPages > 1): ?>
            <nav aria-label="Pagination" class="mt-3">
                <ul class="pagination pagination-sm justify-content-center">
                    <?php
                        $base = 'user_riwayat.php?q=' . urlencode($q) . '&page=';
